      ...
      axios({
        ...
        .then((response) => {
          if (response.data.Service_Performed == true) {
            ...
            toast.success("Запись не завершена");
          }
          getSchedule();
          console.log(response);
        })
        ...
        {admin && !menu ? (
          <>
            ...
            <div className="grid grid-cols-2 mt-2 px-2 gap-2">
              ...
              >
                <option value={"default"}>Сотрудник 1</option>
              ...
              >
                <option value={"default"}>Сотрудник 2</option>
                {employees.map((item: any, index: number) => (
                  <option key={index} value={item.id}>
                    {item.fN}
                  </option>
              ...
              >
                <option value={"default"}>Сотрудник 3</option>
                {employees.map((item: any, index: number) => (
                  <option key={index} value={item.id}>
                    {item.fN}
                  </option>
              ...
              >
                <option value={"default"}>Сотрудник 4</option>
                {employees.map((item: any, index: number) => (
                  <option key={index} value={item.id}>
                    {item.fN}
                  </option>
